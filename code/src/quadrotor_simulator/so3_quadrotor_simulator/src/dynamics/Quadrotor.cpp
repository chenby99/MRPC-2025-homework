                      ...
                      Quadrotor::InternalState& dxdt, const double /* t */)
{
  ...
  // v_dot = //?????
  // v_dot = 重力加速度 + 推力/质量 - 空气阻力/质量 + 外力/质量
  v_dot = - g_ * Eigen::Vector3d(0, 0, 1) + thrust * R.col(2) / mass_ - resistance * vnorm / mass_ + external_force_ / mass_;
