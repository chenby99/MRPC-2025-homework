#ifndef _THETA_STAR_SEARCHER_H
#define _THETA_STAR_SEARCHER_H
...
{	
	...
	protected:
		...
		void ThetaStarGetSucc(MappingNodePtr currentPtr, std::vector<MappingNodePtr> & neighborPtrSets, std::vector<double> & edgeCostSets);		
		...
		// Theta* 核心：line-of-sight 检查
		bool lineOfSight(MappingNodePtr node1, MappingNodePtr node2);
		
	public:
		ThetaStarPath(){};
		~ThetaStarPath(){};
		bool ThetaStarSearch(Eigen::Vector3d start_pt, Eigen::Vector3d end_pt);
